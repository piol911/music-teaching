...
function renderDashboard() {
    ...
    // 低饱和莫兰迪色系，按单元顺序循环取色（与预览一致）
    const palette = ['#5e7280','#a87c57','#7d9069','#8d6f82','#a78f63','#9c7b6e','#6f8aa0','#8a7da0','#7a9c8a','#b09a6a'];
    ...
    grid.innerHTML = '<div class="stack">' + appData.units.map((unit, index) => {
        ...
        return `<div class="stack-card" data-idx="${index}" style="--c:${color}">${thumbHtml}</div>`;
    }).join('') + '</div>';
